...
@Component({
  selector: 'app-pps-4-a',
  templateUrl: './pps-4-a.component.html',
  styleUrls: ['./pps-4-a.component.scss'],
  standalone: true,
  imports: [FormsModule, CommonModule]
})
export class PPS4AComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
      this.chatService.setCollection("messages-pps-4a")
